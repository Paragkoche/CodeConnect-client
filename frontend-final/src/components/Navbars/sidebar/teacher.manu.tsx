            ...
            <List component="div">
              ...
              <ListItem component="div">
                <Button
                  ...
                  disableRipple
                  onClick={() => {
                    _route("/dash-board/Teacher/questions");
                  }}
              ...
              <ListItem component="div">
                <Button
                  ...
                  disableRipple
                  onClick={() => {
                    _route("/dash-board/Teacher/category");
                  }}
                  startIcon={<FaCat />}
                >
                  Category
              ...
              <ListItem component="div">
                <Button
                  ...
                  disableRipple
                  onClick={() => {
                    _route("/dash-board/Teacher/answers");
                  }}
                  startIcon={<FaCheck />}
                >
                  Answers
