...
import { get_questions_s_id_api, submit_answer_api } from "../../../../api";
...
function PageHeader() {
  ...
  const [output, setOut] = React.useState<string>();
              ...
              onClick={() => {
                const options = {
                  ...
                  headers: {
                    ...
                    "X-RapidAPI-Key":
                      "1b9bd6cec6msh5dcd96b4ee2fa71p175f6djsn62cff0ed1ab7",
                  ...
                  data: {
                    ...
                    files: [
                      {
                        name: "filename" + JSON.parse(language).fileExtension,
                        content: code,
                      },
                    ],
                  },
